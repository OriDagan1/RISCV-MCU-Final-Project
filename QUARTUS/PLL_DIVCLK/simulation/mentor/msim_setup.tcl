...
# ----------------------------------------
# If PLL_DIVCLK is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.1 842 win32 2026.08.10.13:57:59
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/PLL_DIVCLK_pll_0.vho" -work pll_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_DIVCLK.vhd"                             
}
